...
public class AmpHandlerTest extends VertxTest {
    ...
    public void shouldRespondWithInternalServerErrorIfAuctionFails() {
        ...
        given(exchangeService.holdAuction(any(), any(), any(), any()))
    ...
    public void shouldRespondWithInternalServerErrorIfCannotExtractBidTargeting() {
        ...
        given(exchangeService.holdAuction(any(), any(), any(), any())).willReturn(givenBidResponseFuture(ext));
    ...
    public void shouldRespondWithDebugInfoIncluded() {
        ...
        given(exchangeService.holdAuction(any(), any(), any(), any())).willReturn(givenBidResponseWithExtFuture(
                mapper.valueToTree(ExtBidResponse.of(ExtResponseDebug.of(null, bidRequest), null, null, null, null))));
    ...
    public void shouldRespondWithAdServerKeyValuesIncluded() {
        ...
        given(exchangeService.holdAuction(any(), any(), any(), any())).willReturn(givenBidResponseWithExtFuture(
                mapper.valueToTree(ExtBidResponse.of(ExtResponseDebug.of(null, bidRequest), null, null, null, adServerKeyValues))));
